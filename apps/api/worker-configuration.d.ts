/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 99bccd2e7f51a15fd2608d0e305f50d5)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		CLOUDFLARE_WEAVER_DATABASE_ID: string;
		CLOUDFLARE_WEAVER_D1_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "LOG_LEVEL" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_WEAVER_DATABASE_ID" | "CLOUDFLARE_WEAVER_D1_TOKEN" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL">> {}
}
